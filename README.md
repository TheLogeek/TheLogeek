...
*   **LogeekMind**
    *   *Link:* [🚀 Visit Live App](https://app.logeekmind.xyz)
...
*   **Nexus-Tech-Dashboard (Predictive Retention Engine)**
    *   *Link:* [🚀 View Live Demo](https://nexus-tech-dashboard.streamlit.app)
    *   *Core Stack:* Python, Streamlit, Pandas, Scikit-learn.
    *   *Architecture:* An interactive Business Intelligence (BI) tool and predictive analytics dashboard. Runs RFM modeling and real-time machine learning risk scoring to simulate multi-variable growth scenarios and flag at-risk customer revenue.
*   **Sales-Forecaster**
