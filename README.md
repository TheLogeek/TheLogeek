...
### Senior Python & Predictive Systems Engineer
...
*   **Nexus-Tech-Dashboard**
    *   *Core Stack:* Python, Streamlit, Pandas.
    *   *Architecture:* An interactive Business Intelligence (BI) tool engineered to simulate multi-variable business growth scenarios, track global sales metrics, and map operational data pipelines.
